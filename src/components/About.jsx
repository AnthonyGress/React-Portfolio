            ...
            <Container>
                <Row>
                    ...
                    <Col size='col-lg-6 aboutWrapper'>
                        ...
                        <p className='about-content-p fs-5'>I am currently a software engineer at Envase Technologies, a SaaS company focused on digitizing the lifecycle of shipping containers and intermodal drayage. My team and I design, create, and maintain and enterprise apps written in Node/TypeScript and Java SpringBoot which leverage the power of AWS cloud infrastructure. I have a passion for learning, creating, and problem solving that is present in all of my work. Using code as my medium, I want to help you build your dream project. I built this website from the ground up using the React library for JavaScript, which allows all the parts of the page to be modular, self-sufficient, and most importantly fast. Check out my portfolio to see some of my work!</p>
                    </Col>
                </Row>
            </Container>
        </section>
