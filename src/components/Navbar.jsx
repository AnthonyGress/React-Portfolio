...
const NavbarContent = (props) => {
    ...
    return (
        <Navbar collapseOnSelect expand='lg' variant='dark' className='w-100 blur' style={props.style} onToggle={blur} fixed='top'>
            <Container style={{ maxWidth: '95vw !important' }}>
                <Navbar.Brand href='#'>
                    <img alt='penrose triangle logo' src={logo} width='50' height='50' className='d-inline-block' />
